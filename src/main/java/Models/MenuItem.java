...
public class MenuItem {
    ...
    public void addOrder(String pizzaType, double pizzaPrice, int pizzaQuantity, String ingredientName, double ingredientPrice) throws SQLException {
        ...
        String sendOrder = "INSERT INTO pizza.orders (pizzaType, pizzaPrice, pizzaQuantity, ingredientName, ingredientPrice) VALUES (?, ?, ?, ?, ?)";
